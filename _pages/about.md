...
.hero-panel {
  ...
  background: linear-gradient(135deg, #f8fafc 0%, #eef6f7 55%, #f6f8f2 100%);
}
.hero-panel h2 {
  margin-top: 0;
  font-size: 1.45rem;
...
<div class="pill-row">
  <span class="pill">Humanoid Robotics</span>
  <span class="pill">Dexterous Manipulation</span>
  <span class="pill">Robot Perception</span>
  <span class="pill">Reinforcement Learning</span>
  <span class="pill">World Models</span>
  <span class="pill">Vision-Language-Action Models</span>
</div>
